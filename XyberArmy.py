...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} JEWEL {k}{loop}{P}/{h}{len(id)}{H} {P}[{h}{ok}{P}] {P}[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
